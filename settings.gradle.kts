...
include(
    ...
    ":exercises:14-primitive-metric-window:starter",
    ":exercises:14-primitive-metric-window:solution",
    ":exercises:15-deadline-ordered-job-collection:starter",
    ":exercises:15-deadline-ordered-job-collection:solution",
    ":exercises:16-jpa-order-summary-n-plus-one:starter",
    ":exercises:16-jpa-order-summary-n-plus-one:solution",
    ":exercises:17-sargable-sql-date-range:starter",
    ":exercises:17-sargable-sql-date-range:solution",
    ":exercises:18-keyset-pagination-stable-traversal:starter",
    ":exercises:18-keyset-pagination-stable-traversal:solution",
    ":exercises:19-dynamodb-batch-read-round-trips:starter",
    ":exercises:19-dynamodb-batch-read-round-trips:solution",
    ":exercises:20-database-pool-admission-control:starter",
    ":exercises:20-database-pool-admission-control:solution",
)
