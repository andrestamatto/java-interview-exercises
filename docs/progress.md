...
| 10 | Async request context / verified | 21 (Temurin 21.0.12.1+1) | Plain Java | none | reused-worker, exceptional cleanup, absent context | `gradlew.bat --no-daemon verifyExercise10`; starter acceptance failed as designed / 2026-09-11 | `ThreadLocal` is local; Java 25 extension remains isolated | Recovery audit / no delegation |
| 11 | Index membership lookups / verified | 21 (Temurin 21.0.12.1+1) | Plain Java | none | output semantics + deterministic operation probe | `gradlew.bat --no-daemon verifyExercise11`; starter acceptance failed as designed / 2026-09-11 | expected hash behavior; no throughput claim | Recovery audit / no delegation |
| 12 | JMH correctness / verified | 21 (Temurin 21.0.12.1+1) | JMH | none | structural contract + JSON smoke | `gradlew.bat --no-daemon verifyExercise12`; `:exercises:12-trustworthy-jmh-benchmark:solution:jmhSmoke`; starter acceptance failed as designed / 2026-09-11 | no score/winner gate | Recovery implementation / no delegation |
| 13 | Allocation / verified | 21 (Temurin 21.0.12.1+1) | JMH, JFR guidance | none | grammar, allocation-shape probe, GC-profiler smoke | `gradlew.bat --no-daemon verifyExercise13`; `:exercises:13-reduce-event-parser-allocation:solution:jmhSmoke`; starter acceptance failed as designed / 2026-09-11 | allocation is not latency; retention extension is explicit | Recovery implementation / no delegation |
