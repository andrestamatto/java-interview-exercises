...
| 11 | Index membership lookups / verified | 21 (Temurin 21.0.12.1+1) | Plain Java | none | differential output + probe extension | `gradlew.bat --no-daemon verifyExercise11` / 2026-09-11 | average hash behavior; no throughput claim | Pending batch review / Sol design |
